...
const marketplaceOptions: { value: MarketplaceType; label: string; description: string }[] = [
  { value: 'shopee', label: 'Shopee', description: '20% (14% + 6% frete) + R$ 4,00' },
  { value: 'mercadolivre-classico', label: 'ML Clássico', description: '~12.5% + taxa variável' },
  { value: 'mercadolivre-premium', label: 'ML Premium', description: '~17.5% + taxa variável' },
  { value: 'pix', label: 'Pix / Direto', description: '0-1% gateway' },
];
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preencha os dados da sua venda para calcular o lucro líquido
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            {inputs.marketplace === 'pix' && (
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Taxa cobrada pelo gateway de pagamento (geralmente 0% a 1%)
                </p>
              </div>
            )}
          </div>
      ...
      {result && (
        <Card className={lucroPositivo ? 'border-green-500' : 'border-red-500'}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <TrendingUp className={`h-6 w-6 ${lucroPositivo ? 'text-green-600' : 'text-red-600'}`} />
              Resultado da Venda
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="border-t pt-4">
              <h4 className="font-semibold text-gray-900 mb-3">Detalhamento de Custos</h4>
