...
- [ ] Open terminal
- [ ] Run: `cd /Users/dburnier/Documents/my_repos/dbc-data-studio/abigail2`
- [ ] Run: `sqlite3 abigail2.db "SELECT name, email, email_sent, email_sent_at FROM submissions ORDER BY timestamp DESC LIMIT 1;"`
- [ ] Verify:
  - [ ] `email_sent = 1`
